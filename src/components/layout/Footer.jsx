      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 pb-12">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            >
              <div className="w-8 h-8 flex items-center justify-center text-[#D8B452] group-hover:rotate-90 transition-transform duration-500">
                ...
                <form onSubmit={handleSubscribe} className="space-y-1.5 max-w-sm">
                  <div className="relative flex items-center">
                    <input
                      ...
                      className={`w-full pl-3.5 pr-24 py-2 text-xs rounded-xl bg-white dark:bg-zinc-950 border text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-1 focus:ring-[#8E6FFF] transition-colors ${
                        error
                          ? 'border-rose-500'
                    ...
                    <button
                      type="submit"
                      disabled={isLoading}
                      className="absolute right-1 px-3 py-1 text-xs font-bold rounded-lg bg-gradient-to-r from-[#6833FF] to-[#8E6FFF] text-white hover:opacity-95 shadow-md shadow-[#6833FF]/20 transition-all cursor-pointer disabled:opacity-50 flex items-center gap-1"
                    >
                      {isLoading ? (
                ...
                {footerLinks.product.map((item) => (
                  <li key={item.name}>
                    <a
                      ...
                      className="text-xs text-slate-600 dark:text-zinc-400 hover:text-[#D8B452] dark:hover:text-[#F3D887] transition-colors cursor-pointer"
                    >
                      {item.name}
                    </a>
                  </li>
