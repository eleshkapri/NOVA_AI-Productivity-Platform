...
export function Footer() {
  ...
  return (
    <footer id="footer" className="bg-[#050614] border-t border-white/10 pt-20 pb-14 text-white transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 pb-16 border-b border-white/10">
          ...
          <div className="lg:col-span-5 space-y-5">
            <a href="#" className="flex items-center gap-3">
              <div className="w-10 h-10 flex items-center justify-center text-[#D8B452]">
            ...
            <div className="flex items-center gap-2.5 pt-2">
              <span className="relative flex h-2.5 w-2.5">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#D8B452] opacity-75"></span>
                <span className="relative inline-flex rounded-full h-2.5 w-2.5 bg-[#D8B452]"></span>
              </span>
          ...
          {/* Newsletter Form */}
          <div className="lg:col-span-7 bg-[#0b0c33]/70 p-7 sm:p-9 rounded-3xl border border-[#D8B452]/20 shadow-xl backdrop-blur-2xl">
            ...
            {isSubmitted ? (
              <div className="mt-6 p-4.5 rounded-2xl bg-[#D8B452]/10 border border-[#D8B452]/30 flex items-start gap-3.5">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <div className="relative flex-1">
                    <input
                      ...
                      className={`w-full px-5 py-3 text-sm rounded-full bg-[#050614] border text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-[#D8B452] transition-all ${
                        error
                  ...
                  <button
                    type="submit"
                    disabled={isLoading}
                    className="inline-flex items-center justify-center px-7 py-3 text-sm font-bold uppercase tracking-wider rounded-full bg-gradient-to-r from-[#D8B452] to-[#B88A23] text-black shadow-lg shadow-[#D8B452]/20 hover:opacity-95 transition-all cursor-pointer disabled:opacity-50"
                  >
                    {isLoading ? (
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 py-14">
          <div>
            <h5 className="text-xs font-bold uppercase tracking-[0.2em] text-[#D8B452] mb-5">
              Product
            </h5>
            <ul className="space-y-3">
              {footerLinks.product.map((item) => (
                <li key={item.name}>
                  <a
                    href={item.href}
                    className="text-sm text-slate-400 hover:text-[#D8B452] transition-colors"
                  >
                    {item.name}
                  </a>
                </li>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-5">
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              className="p-2.5 rounded-full text-slate-400 hover:text-[#D8B452] hover:bg-white/5 transition-colors"
            >
