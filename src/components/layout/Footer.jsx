...
export function Footer({ onOpenModal }) {
  ...
  return (
    <footer id="footer" className="bg-slate-50/70 dark:bg-[#03040e]/90 backdrop-blur-2xl border-t border-slate-200/80 dark:border-white/10 pt-16 pb-12 text-slate-800 dark:text-white transition-colors relative z-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 pb-12">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            >
              <div className="w-8 h-8 flex items-center justify-center text-[#a1741a] dark:text-[#D8B452] group-hover:rotate-90 transition-transform duration-500">
                ...
                <form onSubmit={handleSubscribe} className="space-y-1.5 max-w-sm">
                  <div className="relative flex items-center">
                    <input
                      ...
                      className={`w-full pl-3.5 pr-24 py-2 text-xs rounded-xl bg-white dark:bg-[#07081e] border text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-1 focus:ring-[#D8B452] transition-colors ${
                        error
                          ? 'border-rose-500'
                    ...
                    <button
                      type="submit"
                      disabled={isLoading}
                      className="absolute right-1 px-3 py-1 text-xs font-bold rounded-lg bg-[#D8B452] text-black hover:bg-[#F3D887] transition-all cursor-pointer disabled:opacity-50 flex items-center gap-1"
                    >
                      {isLoading ? (
                ...
                {footerLinks.product.map((item) => (
                  <li key={item.name}>
                    <a
                      ...
                      className="text-xs text-slate-600 dark:text-slate-400 hover:text-[#a1741a] dark:hover:text-[#D8B452] transition-colors cursor-pointer"
                    >
                      {item.name}
                    </a>
                  </li>
        ...
        <div className="pt-8 border-t border-slate-200/70 dark:border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500 dark:text-slate-400">
          <p>
