    ...
    <footer id="footer" className="bg-slate-100/90 dark:bg-[#050614] border-t border-slate-200 dark:border-white/10 pt-20 pb-14 text-slate-800 dark:text-white transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 pb-16 border-b border-slate-200 dark:border-white/10">
          ...
          {/* Newsletter Form */}
          <div className="lg:col-span-7 bg-white dark:bg-[#0b0c33]/70 p-7 sm:p-9 rounded-3xl border border-slate-200 dark:border-[#D8B452]/20 shadow-md dark:shadow-xl backdrop-blur-2xl transition-all duration-300 hover:border-[#a1741a]/60 dark:hover:border-[#D8B452]/50 hover:shadow-2xl hover:shadow-[#D8B452]/10 hover:-translate-y-1">
                    ...
                    <input
                      ...
                      className={`w-full px-5 py-3 text-sm rounded-full bg-slate-50 dark:bg-[#050614] border text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[#D8B452] transition-all ${
                        error
                          ...
                          : 'border-slate-200 dark:border-white/10 hover:border-[#a1741a]/30 dark:hover:border-[#D8B452]/30'
                      }`}
                    />
                  </div>
                  <button
                    type="submit"
                    disabled={isLoading}
                    className="inline-flex items-center justify-center px-7 py-3 text-sm font-bold uppercase tracking-wider rounded-full bg-gradient-to-r from-[#D8B452] to-[#B88A23] text-black shadow-md shadow-[#D8B452]/20 hover:shadow-xl hover:shadow-[#D8B452]/40 hover:scale-105 active:scale-95 transition-all duration-300 cursor-pointer disabled:opacity-50 group"
                  >
                    {isLoading ? (
        ...
        <div className="pt-8 border-t border-slate-200 dark:border-white/10 flex flex-col sm:flex-row items-center justify-between gap-5">
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              className="p-2.5 rounded-full text-slate-500 dark:text-slate-400 hover:text-[#a1741a] dark:hover:text-[#D8B452] hover:bg-slate-200/80 dark:hover:bg-white/10 hover:scale-120 active:scale-90 hover:shadow-md hover:shadow-[#D8B452]/25 transition-all duration-300"
            >
