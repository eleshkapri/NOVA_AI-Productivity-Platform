      ...
      {!isCompleted ? (
        ...
        <div className="space-y-6 animate-fade-in">
          ...
          <div className="flex items-center justify-between pb-4 border-b border-slate-200 dark:border-white/10">
            <div>
              <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#D8B452] dark:text-[#F3D887]">
        ...
        <div className="space-y-6 animate-fade-in">
          {/* Top Score Ribbon */}
          <div className="p-5 sm:p-6 rounded-3xl bg-zinc-900/70 border border-[#D8B452]/40 text-white flex flex-col md:flex-row items-start md:items-center justify-between gap-6 shadow-xl backdrop-blur-xl">
          ...
          <div className="p-5 rounded-2xl bg-slate-50 dark:bg-zinc-900/40 border border-slate-200 dark:border-white/10 space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
              <div className="p-3 rounded-xl bg-white dark:bg-zinc-900/60 border border-slate-200 dark:border-white/5 space-y-1">
                <span className="font-bold text-[#D8B452] dark:text-[#F3D887] flex items-center gap-1">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 pt-2">
            <div className="flex items-center gap-2">
              <button
                ...
                className={`flex-1 sm:flex-none flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-gradient-to-r from-[#6833FF] to-[#8E6FFF] hover:opacity-95 text-white text-xs font-bold transition-all shadow-md shadow-[#6833FF]/25 cursor-pointer ${
            ...
            <button
              ...
              className="floria-btn-purple px-5 py-2.5 text-xs font-bold transition-all cursor-pointer"
            >
