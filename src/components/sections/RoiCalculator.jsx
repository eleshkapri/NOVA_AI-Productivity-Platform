...
export function RoiCalculator({ onOpenDemo }) {
  ...
  return (
    <section id="roi-calculator" className="py-16 md:py-24 relative overflow-hidden backdrop-blur-xs">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <MotionReveal animation="fade-up" delay={120}>
          <div className="max-w-5xl mx-auto bg-white/95 dark:bg-[#07081e]/60 rounded-[2.5rem] p-8 sm:p-12 border border-slate-200/90 dark:border-white/10 shadow-xl dark:shadow-2xl backdrop-blur-2xl ring-1 ring-inset ring-white/5">
            {/* Mode Switcher Tabs */}
                ...
                <button
                  ...
                  className={`flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-bold transition-all cursor-pointer ${
                    activeMode === 'calculator'
                      ? 'bg-gradient-to-r from-[#6833FF] to-[#8E6FFF] text-white shadow-sm font-extrabold'
            ...
            {activeMode === 'calculator' ? (
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
                ...
                <div className="lg:col-span-6 space-y-8">
                  ...
                  <span className="text-xl font-mono font-bold text-[#D8B452] dark:text-[#F3D887]">
                    {teamSize} Engineers
                  </span>
                </div>
                <input
                  ...
                  className="w-full h-2 bg-slate-200 dark:bg-zinc-950 rounded-lg appearance-none cursor-pointer accent-[#D8B452]"
                />
            ...
            <div className="lg:col-span-6 bg-[#050614] p-5 sm:p-8 rounded-[2rem] border border-[#D8B452]/40 shadow-2xl space-y-6 text-white ring-1 ring-inset ring-white/5">
              <span className="text-[10px] font-mono font-bold uppercase tracking-[0.25em] text-[#D8B452]">
              ...
              <div>
                <div className="flex items-baseline gap-2">
                  ...
                  <span className="text-5xl sm:text-6xl font-black font-mono text-gold-gradient tracking-tighter">
              ...
              <div className="pt-2 flex flex-col sm:flex-row gap-3">
                <Button
                  ...
                  icon={ArrowRight}
                  iconPosition="right"
                  className="w-full justify-center text-sm flex-1 shadow-lg shadow-[#6833FF]/25"
                ...
                {onOpenDemo && (
                  <button
                    ...
                    className="px-5 py-2.5 rounded-full border border-white/10 hover:border-[#D8B452]/40 text-xs font-semibold text-zinc-300 hover:text-white transition-colors cursor-pointer"
                  >
                    Custom Audit
                  </button>
                )}
