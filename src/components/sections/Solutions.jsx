    ...
    <section id="solutions" className="py-14 md:py-20 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              return (
                <button
                  ...
                  className={`px-5 sm:px-6 py-2.5 sm:py-3 rounded-full text-xs sm:text-sm font-bold uppercase tracking-wider transition-all duration-200 cursor-pointer active:scale-95 ${
                    isActive
                      ? 'bg-gradient-to-r from-[#6833FF] via-[#7B42FF] to-[#8E6FFF] text-white shadow-lg shadow-[#6833FF]/30 border border-[#A78BFA]/50'
                      : 'bg-white/80 dark:bg-[#07081e]/70 text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-white/10 hover:border-[#8E6FFF] hover:text-black dark:hover:text-white shadow-xs'
                  }`}
                >
                  {sol.title}
                </button>
        ...
        <MotionReveal animation="zoom-in" delay={120}>
          <div className="bg-white/95 dark:bg-[#07081e]/90 rounded-3xl p-6 sm:p-10 lg:p-12 border border-slate-200/90 dark:border-white/10 shadow-2xl relative overflow-hidden backdrop-blur-2xl orchid-card">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-center">
              ...
              <div className="lg:col-span-5 space-y-5">
                ...
                <div className="bg-slate-50 dark:bg-[#050614] p-4 sm:p-5 rounded-2xl border border-slate-200 dark:border-white/10 space-y-2">
                  <div className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#D8B452] mb-2 flex items-center gap-1.5">
                  ...
                  {currentSolution.highlights.map((highlight, index) => (
                    <div
                      key={index}
                      className="flex items-start gap-2.5 p-1.5 rounded-lg hover:bg-amber-500/10 transition-colors cursor-default"
                    >
              ...
              <div className="lg:col-span-7">
                <div className="group relative rounded-2xl sm:rounded-3xl overflow-hidden bg-black border border-[#8E6FFF]/30 shadow-2xl">
                  {/* Top Hologram HUD Header */}
                  <div className="px-4 py-2.5 bg-[#050614]/90 border-b border-white/10 flex items-center justify-between text-[11px] font-mono">
                  ...
                  <div className="relative overflow-hidden aspect-16/9">
                    ...
                    <div className="absolute bottom-3 left-3 right-3 flex flex-wrap items-center justify-between gap-2 p-2.5 rounded-xl bg-black/75 border border-white/15 backdrop-blur-md text-[11px] font-mono text-white">
                      <div className="flex items-center gap-1.5 text-[#D8B452]">
