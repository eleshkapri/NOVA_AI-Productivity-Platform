        ...
        <div className="animate-marquee flex items-center gap-6 sm:gap-8">
          {marqueeItems.map((company, index) => (
            <div
              ...
              className="flex items-center gap-3 px-6 py-3.5 rounded-2xl border border-slate-200/60 dark:border-white/10 bg-white/90 dark:bg-[#07081e]/90 hover:-translate-y-1.5 hover:shadow-xl hover:shadow-[#6833FF]/20 transition-all duration-300 cursor-pointer group shrink-0 orchid-card"
            >
              <span className="text-2xl font-bold text-slate-500 dark:text-slate-400 group-hover:text-[#A78BFA] group-hover:scale-115 transition-all duration-300">
                {company.symbol}
              </span>
              <div className="flex flex-col">
                ...
                <span className="text-[9px] uppercase tracking-widest text-slate-400 dark:text-slate-500 group-hover:text-[#A78BFA] transition-colors">
                  {company.badge}
                </span>
              </div>
            </div>
