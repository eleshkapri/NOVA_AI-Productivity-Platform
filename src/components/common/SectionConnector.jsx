...
export function SectionConnector({
  ...
  return (
    <div className={`relative py-1.5 md:py-2.5 flex items-center justify-center overflow-hidden pointer-events-none select-none ${className}`}>
      ...
      <div className="relative z-10 inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full bg-white dark:bg-zinc-950 border border-slate-300 dark:border-white/10 shadow-md backdrop-blur-md text-[11px] font-mono tracking-wider text-slate-800 dark:text-zinc-300">
        ...
        <span className="text-[10px] font-extrabold text-orange-600 dark:text-orange-400 uppercase">{metric}</span>
      </div>
    </div>
  );
}
