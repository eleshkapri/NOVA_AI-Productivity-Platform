...
export function AmbientBackground() {
  ...
  return (
    <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden bg-gradient-to-b from-[#FFFFFF] via-[#F8FAFC] to-[#F1F5F9] dark:from-[#0b0c26] dark:via-[#070818] dark:to-[#04050d] transition-colors duration-500">
      ...
      <div className="absolute -top-40 left-1/4 w-[450px] md:w-[750px] h-[700px] md:h-[1200px] bg-gradient-to-b from-[#7C3AED]/14 via-[#A78BFA]/10 to-transparent dark:from-[#6833FF]/20 dark:via-[#8E6FFF]/10 blur-3xl pointer-events-none" />
      <div className="hidden md:block absolute -top-60 right-1/4 w-[650px] h-[1100px] bg-gradient-to-b from-[#EA580C]/12 via-orange-300/10 to-transparent dark:from-[#FF5500]/15 dark:via-orange-950/20 blur-3xl pointer-events-none" />
      <div className="hidden md:block absolute top-1/4 left-1/3 w-[600px] h-[1000px] bg-gradient-to-b from-[#0284C7]/12 via-[#38BDF8]/8 to-transparent dark:from-[#0284C7]/15 dark:via-cyan-600/10 blur-3xl pointer-events-none" />

      {/* 3. Fluid Static Ambient Gradient Orbs (Streamlined with blur-3xl for zero GPU bottleneck) */}
      <div className="absolute -top-32 -left-32 w-[400px] md:w-[720px] h-[400px] md:h-[720px] rounded-full bg-gradient-to-br from-[#7C3AED]/10 via-[#DDD6FE]/14 to-transparent dark:from-[#6833FF]/25 dark:via-[#8E6FFF]/10 blur-3xl pointer-events-none" />
      ...
      <div className="hidden md:block absolute top-1/3 -right-44 w-[780px] h-[780px] rounded-full bg-gradient-to-bl from-amber-400/12 via-amber-200/10 to-transparent dark:from-indigo-600/25 dark:via-zinc-950/70 blur-3xl pointer-events-none" />
      <div className="hidden md:block absolute bottom-1/4 -left-20 w-[620px] h-[620px] rounded-full bg-gradient-to-tr from-[#0284C7]/10 via-[#BAE6FD]/12 to-transparent dark:from-[#0284C7]/20 dark:via-[#0369a1]/10 blur-3xl pointer-events-none" />
      <div className="absolute top-2/3 left-1/5 w-[380px] md:w-[620px] h-[380px] md:h-[620px] rounded-full bg-gradient-to-tr from-[#EA580C]/10 via-[#FFEDD5]/14 to-transparent dark:from-[#FF5500]/12 dark:via-orange-950/20 blur-3xl pointer-events-none" />
      <div className="hidden md:block absolute -bottom-40 right-1/3 w-[700px] h-[700px] rounded-full bg-gradient-to-tl from-[#7C3AED]/9 via-[#EDE9FE]/12 to-transparent dark:from-[#6833FF]/20 dark:via-zinc-950/65 blur-3xl pointer-events-none" />
